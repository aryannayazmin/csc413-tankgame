...
public class Launcher {
     ...
     * to sub-panels depending on tankrotationexample.game state.
     */
    ...
    /*
     * tankrotationexample.game panel is used to show our tankrotationexample.game to the screen. inside this panel
     * also contains the tankrotationexample.game loop. This is where out objects are updated and
     * redrawn. This panel will execute its tankrotationexample.game loop on a separate thread.
    ...
    /*
     * end panel is used to show the end tankrotationexample.game panel.  it will contain
     ...
     * used for our tankrotationexample.game. It will be attached to the main panel.
     */
    ...
    private void initUIComponents() throws IOException {
        ...
        this.gamePanel = new TRE(this); // create a new tankrotationexample.game panel
        this.gamePanel.gameInitialize(); // initialize tankrotationexample.game, but DO NOT start tankrotationexample.game
        this.endPanel = new EndGamePanel(this); // create a new end tankrotationexample.game pane;
        ...
        this.mainPanel.add(gamePanel, "game");   //add the tankrotationexample.game panel to the main panel
        this.mainPanel.add(endPanel, "end");    // add the end tankrotationexample.game panel to the main panel
    ...
    public void setFrame(String type){
        ...
        switch(type){
            case "start":
                ...
                break;
            case "game":
                // set the size of the jFrame to the expected size for the tankrotationexample.game panel
                this.jf.setSize(GameConstants.GAME_SCREEN_WIDTH,GameConstants.GAME_SCREEN_HEIGHT);
                //start a new thread for the tankrotationexample.game to run. This will ensure our JFrame is responsive and
                // not stuck executing the tankrotationexample.game loop.
